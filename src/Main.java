...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long[] alphas = new long[] { 0, 0, 1000, 1000, 0, 1000, 0, 1000, 1000, 0 }; // Example values, replace with actual alpha values
        PetriNet petriNet = new PetriNet(MAX_INVARIANTS, logger, alphas);
